...
| [Feature Request] Add Spanish language support for microphon | GitHub Issues (enhancement) | **Bug Description**
Sería bueno que la transcripsión desde el microfo, que pueda |
| [Feature Request] Add internationalization (i18n) support fo | GitHub Issues (enhancement) | **Bug Description**
A interface do CLI (menus, prompts interativos, atalhos) pod |
| [BUG] Claude Code is not local inference friendly | GitHub Issues (enhancement) | ### Preflight Checklist

- [x] I have searched [existing issues](https://github. |
| [BUG]  AskUserQuestion tool limited to 4 options is too rest | GitHub Issues (enhancement) | ### Preflight Checklist

- [x] I have searched [existing issues](https://github. |
| türkçe kullanım desteği | GitHub Issues (enhancement) | ### Preflight Checklist

- [x] I have searched [existing requests](https://githu |
| Voice input transcription quality needs improvement — punctu | GitHub Issues (enhancement) | The microphone/voice input in Claude Code frequently misplaces punctuation (inse |
| [FEATURE] Support riscv64 (linux/riscv64) architecture | GitHub Issues (enhancement) | ### Preflight Checklist

- [x] I have searched [existing requests](https://githu |
| [FEATURE] WriteTemp() tool | GitHub Issues (enhancement) | ### Preflight Checklist

- [x] I have searched [existing requests](https://githu |
| [FEATURE] Add memory-compaction-proof ~/.claude/INVARIANT.md | GitHub Issues (enhancement) | ### Preflight Checklist
...
---
Total new uncovered entries: **10**
